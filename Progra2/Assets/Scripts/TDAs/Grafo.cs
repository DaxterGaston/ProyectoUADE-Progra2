...
namespace TDAs
{
    public class GrafoMA : IGrafoTDA
    {
        ...
        /// <summary>
        /// Agrego una nueva arista.
        /// </summary>
        /// <param name="id">Id de la arista (no puede repetirse)</param>
        /// <param name="v1">Id del nodo origen.</param>
        /// <param name="v2">Id del nodo destino.</param>
